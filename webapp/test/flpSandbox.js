		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#cgcoepiperapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cgcoepiperapp-display": {
								"semanticObject": "cgcoepiperapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cg.coe.piperapp",
									"url": sap.ui.require.toUrl("cg/coe/piperapp")
								}
							}
						}
					}
